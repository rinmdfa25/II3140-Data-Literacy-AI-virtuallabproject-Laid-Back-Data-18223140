      ...
      <section className="register-section flex flex-1 flex-col md:flex-row">
        ...
        <div className="relative z-10 w-full md:w-[30%] ml-auto bg-sky-600 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            <h2 className="text-4xl font-bold mb-4 mt-20 text-white text-center">Login</h2>
            ...
            <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2 bg-teal-600 text-white font-semibold py-2 rounded-md hover:bg-teal-700 mb-6 shadow-sm">
              <svg className="w-5 h-5" viewBox="0 0 48 48">
                ...
                <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C44.591,33.018,48,27.455,48,20C48,17.21,47.875,14.49,47.455,11.94l-6.522,5.025C41.673,17.846,42,18.883,42,20z"></path>
              </svg>
              Sign in with Google
            </button>

            <p className="text-center text-white mb-2 mt-4">Don't have an account?</p>
            <div className="flex justify-center">
              <a href="/register">
                <button type="button" className="bg-teal-600 w-64 text-xs justify-center text-white py-2 rounded-md hover:bg-teal-700 transition-colors font-semibold">
